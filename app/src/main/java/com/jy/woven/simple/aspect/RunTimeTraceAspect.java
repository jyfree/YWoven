package com.jy.woven.simple.aspect;


import com.jy.woven.simple.YLogUtils;
...
public class RunTimeTraceAspect {
    ...
    private static final String POINTCUT_METHOD =
            "execution(@com.jy.woven.simple.aspect.RunTimeTrace * *(..))";

    private static final String POINTCUT_CONSTRUCTOR =
            "execution(@com.jy.woven.simple.aspect.RunTimeTrace *.new(..))";
    ...
    public Object weaveJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        YLogUtils.INSTANCE.iFormat("性能监控--》执行方法耗时--%s--%s--%s(ms)", className, methodName, endTime - startTime);
        return result;
    }
    ...
    public Object stopJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Object result = joinPoint.proceed();
        YLogUtils.INSTANCE.iFormat("性能监控--》停留时间--%s--%s(ms)", className, System.currentTimeMillis() - startTime);
        return result;
    }
    ...
    public void destroyJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        String className = joinPoint.getTarget().getClass().getSimpleName();
        joinPoint.proceed();
        YLogUtils.INSTANCE.iFormat("性能监控--》页面销毁--%s", className);
    }
    ...
    public Object onViewCreatedFragmentJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Object result = joinPoint.proceed();
        YLogUtils.INSTANCE.iFormat("性能监控--》fragment创建耗时--%s--%s(ms)", className, System.currentTimeMillis() - startTime);
        return result;
    }
